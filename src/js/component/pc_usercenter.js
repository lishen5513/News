...
export default class PCUserCenter extends React.Component{
    ...
    componentDidMount(){
        ...
        fetch("http://newsapi.gugujiankong.com/Handler.ashx?action=getusercomments&userid="+localStorage.userId, fetchOptions).then(response=>response.json).then(json=>{
                        ...
                        <Tabs>
                            ...
                            <TabPane tab="头像设置" key="3">
                                <div class="clearfix">
                                    ...
                                    <Modal visible ={this.state.previewVisble} footer={null} onCancel={this.handleCancel}>
