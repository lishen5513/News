...
class PCHeader extends React.Component{
    ...
    handleSubmit(e){
        ...
        fetch("http://newsapi.guanjiankong.com/Handler.ashx?action="+this.state.action
                        ...
                        <Modal title="用户中心" wrapClassName="vertical-center-modal" visible={this.state.modalVisible
                            ...
                            <Tabs type="card" onchange={this.callback.bind(this)}>
                                ...
                                <TabPane tab="注册" key="2">
                                    <Form horizontal onSubmit={this.handleSubmit.bind(this)}>
                                        <FormItem label="账户">
                                            <Input type="password" placeholder="请输入您的账号" {...getFieldProps("r_userName")}/>
                                        </FormItem>
                                        <FormItem label="密码">
                                            <Input type="password" placeholder="请输入您的密码" {...getFieldProps('r_password')}/>
                                        </FormItem>
                                        <FormItem label="确认密码">
                                            <Input type="password" placeholder="请再次输入密码" {...getFieldProps("r_confirmPass")}/>
                                        </FormItem>
                                    </Form>
                                </TabPane>
                            </Tabs>
